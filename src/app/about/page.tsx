    ...
    <main className="relative border-l-2 border-l-[#BBFF00] h-screen w-full flex flex-col gap-44 justify-center px-8">
       ...
       <div className='z-50'>
         ...
         <ul className="mb-8 text-stone-100 flex gap-8 text-2xl">
          ...
          <p className="text-stone-400 text-lg mb-6">Special thanks to <b className='text-stone-100'>Cris Malajos</b> for fixing backend related errors. Check out his <a className="text-[#BBFF00]" href="https://github.com/sibicb">GIthub Account</a>.
          </p>
       </div>
